...
namespace Abc.Tests
{
    internal class htmlHelperMock<TModel> : IHtmlHelper<TModel>
    {
        ...
        ViewDataDictionary IHtmlHelper.ViewData { get; } = null;
        ...
        public IHtmlContent DisplayFor<TResult>(Expression<Func<TModel, TResult>> expression, string templateName, string htmlFieldName, object additionalViewData) => new htmlContentMock("DisplayFor");
        ...
        public string DisplayNameFor<TResult>(Expression<Func<TModel, TResult>> e) => "DisplayNameFor";

        public string DisplayNameForInnerType<TModelItem, TResult>(Expression<Func<TModelItem, TResult>> e) => "DisplayNameForInnerType";
        ...
        public string DisplayTextFor<TResult>(Expression<Func<TModel, TResult>> e) => "DisplayTextFor";
        ...
        public IHtmlContent DropDownListFor<TResult>(Expression<Func<TModel, TResult>> e, IEnumerable<SelectListItem> selectList, string optionLabel, object htmlAttributes) => new htmlContentMock("ListFor");
        ...
        public IHtmlContent EditorFor<TResult>(Expression<Func<TModel, TResult>> e, string templateName, string htmlFieldName, object additionalViewData) => new htmlContentMock("EditorFor");
        ...
        public IHtmlContent HiddenFor<TResult>(Expression<Func<TModel, TResult>> e, object htmlAttributes) => new htmlContentMock("HiddenFor");
        ...
        public string IdFor<TResult>(Expression<Func<TModel, TResult>> e) => "IdFor";
        ...
        public IHtmlContent LabelFor<TResult>(Expression<Func<TModel, TResult>> e, string labelText, object htmlAttributes) => new htmlContentMock("LabelFor");
        ...
        public IHtmlContent ListBoxFor<TResult>(Expression<Func<TModel, TResult>> expression, IEnumerable<SelectListItem> selectList, object htmlAttributes) => new htmlContentMock("ListBoxFor");
        ...
        public string NameFor<TResult>(Expression<Func<TModel, TResult>> e) => "NameFor";
        ...
        public IHtmlContent PasswordFor<TResult>(Expression<Func<TModel, TResult>> expression, object htmlAttributes) => new htmlContentMock("PasswordFor");
        ...
        public IHtmlContent RadioButtonFor<TResult>(Expression<Func<TModel, TResult>> expression, object value, object htmlAttributes) => new htmlContentMock("RadioButtonFor");
        ...
        public IHtmlContent TextAreaFor<TResult>(Expression<Func<TModel, TResult>> e, int rows, int columns, object htmlAttributes) => new htmlContentMock("TextAreaFor");
        ...
        public IHtmlContent TextBoxFor<TResult>(Expression<Func<TModel, TResult>> e, string format, object htmlAttributes) => new htmlContentMock("TextBoxFor");
        ...
        public IHtmlContent ValidationMessageFor<TResult>(Expression<Func<TModel, TResult>> e, string message, object htmlAttributes, string tag) => new htmlContentMock("ValidationMessageFor");
